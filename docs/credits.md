...
`compas_nest` is released under the **MIT License**. Each dependency keeps its own license; if you
redistribute, include the upstream licenses for the bundled components (Clipper2, Boost.Polygon).
